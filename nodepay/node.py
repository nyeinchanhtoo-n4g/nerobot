...
class AccountSession:
    ...
    async def get_proxies(self):
        try:
            account_proxy_path = Path(f'../personaldata/proxy/node_proxy/{self.account_id}.nerodata')
            proxy_data = ''
            if account_proxy_path.is_file():
                async with aiofiles.open(account_proxy_path, 'r') as f:
                    proxy_data = await f.read()
            else:
                root_proxy_path = Path('../personaldata/proxy/node_proxy/node_proxies.nerodata')
...
$$ |\$$$ |$$\   $$ |$$ |  $$ |$$ |\$$$ |      $$ |  $$ |$$ |  $$ |  $$ |   
$$ | \$$ |\$$$$$$  |$$ |  $$ |\$$$$$$  /      $$$$$$$  | $$$$$$  |  $$ |   
\__|  \__| \______/ \__|  \__| \______/       \_______/  \______/   \__|   
===========================================================================
|                           NodePay Bot                                   |
